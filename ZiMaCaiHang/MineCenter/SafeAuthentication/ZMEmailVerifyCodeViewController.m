...
@interface ZMEmailVerifyCodeViewController ()<UITableViewDelegate, UITableViewDataSource, UIAlertViewDelegate, UITextFieldDelegate, MBProgressHUDDelegate>
{
...
@implementation ZMEmailVerifyCodeViewController
...
//    self.tableView.allowsSelection = NO;
    ...
    reuseCellIndentifier = @"ZMEmailVerifyTableViewCell";
...
//    {
//        ZMEmailVerifyTableViewCell *cell = (ZMEmailVerifyTableViewCell *)[self.tableView  cellForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:0]];
...
{
    ZMEmailVerifyTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseCellIndentifier];
    
    if (!cell) {
        cell=[[ZMEmailVerifyTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseCellIndentifier];
    }
