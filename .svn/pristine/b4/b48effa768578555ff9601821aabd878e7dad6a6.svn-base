...
-(void)getUserName
{
    ...
    [self.headerImage.layer setCornerRadius:CGRectGetHeight([self.headerImage bounds]) / 2];
...
//    _userNameLabel.font = [UIFont boldSystemFontOfSize:15];
    if (HEIGHT_OF_SCREEN == 480) {
        _userNameLabel.frame = CGRectMake(0, HEIGHT_OF_SCREEN/568*123, WIDTH_OF_SCREEN, HEIGHT_OF_SCREEN/568*20);
        _allRedMoney.frame = CGRectMake(0, HEIGHT_OF_SCREEN/568*155, WIDTH_OF_SCREEN, HEIGHT_OF_SCREEN/568*40);
    }else {
...
-(void)createTableView{
    ...
    _tableView.backgroundColor = [ZMTools ColorWith16Hexadecimal:@"f9f9f9"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (userRewardArr.count > 0) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            cell.typeNameLable.font = [UIFont fontWithName:@"MicrosoftYaHei" size:GTFixHeightFlaot(15)];
            cell.dateLabel.font = [UIFont fontWithName:@"MicrosoftYaHei" size:GTFixHeightFlaot(13)];
            cell.rmbLabel.font = [UIFont fontWithName:@"MicrosoftYaHei" size:GTFixHeightFlaot(13)];
