...
- (id)initWithFrame:(CGRect)frame andLine:(CGFloat)lineWidth
{
...
- (void)animateToStrokeEnd:(CGFloat)strokeEnd
{
    ...
    strokeAnimation.dynamicsTension = 99;
//    strokeAnimation.dynamicsFriction =12;
//    strokeAnimation.dynamicsMass = 12;
    CLog(@"%f",strokeAnimation.dynamicsTension);
    CLog(@"%f",strokeAnimation.dynamicsFriction);
    CLog(@"%f",strokeAnimation.dynamicsMass);
